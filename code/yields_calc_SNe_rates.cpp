...
void SNe_rates()
{
  ...
  int Mi_lower, Mi_upper, Mi_lower_SNII, Mi_upper_SNII, Zi_SNII, Zi_AGB, Mi_lower_AGB, Mi_upper_AGB,
    t_lower_lifetime, t_upper_lifetime;
  double dt, t_lower, t_upper, DTD_lower, DTD_upper;
  double Mi_lower_actual, Mi_upper_actual, SNIIEjectedMasses_lower_actual, SNIIEjectedMasses_upper_actual,
    SNIITotalMetals_lower_actual, SNIITotalMetals_upper_actual, SNIIYields_lower_actual[NUM_ELEMENTS],
    SNIIYields_upper_actual[NUM_ELEMENTS];
  double AGBEjectedMasses_lower_actual, AGBEjectedMasses_upper_actual, AGBTotalMetals_lower_actual,
    AGBTotalMetals_upper_actual, AGBYields_lower_actual[NUM_ELEMENTS], AGBYields_upper_actual[NUM_ELEMENTS];
                      ...
                      if(Mi_lower_SNII <= Mi_upper_SNII)
                        {
                          ...
                          find_actual_ejecta_limits(2, Mi_lower_actual, Mi_upper_actual, Mi_lower_SNII,
                                                    Mi_upper_SNII, Zi_SNII, &SNIIEjectedMasses_lower_actual,
                                                    &SNIIEjectedMasses_upper_actual,
                                                    &SNIITotalMetals_lower_actual,
                                                    &SNIITotalMetals_upper_actual, SNIIYields_lower_actual,
                                                    SNIIYields_upper_actual);
                              ...
                              if(SNIIMasses[j] <= SNIA_MAX_MASS)        //For mass range where both SN-II and SN-Ia progenitors are possible
                                {
                                  if(j != Mi_lower_SNII && j != Mi_upper_SNII)  //If mass bin j is NEITHER the lowest NOR highest mass bin to be integrated over.
                                    {
                                      L1a++;
                                      SNIIRate2[(STEPS * snap) + step][Zi] +=
                                        (1.0 - A_FACTOR) * (SNIIMasses[j + 1] -
                                                            SNIIMasses[j]) * ((Chabrier_IMF(SNIIMasses[j]) *
                                                                               TheSFH2[i]) +
                                                                              (Chabrier_IMF(SNIIMasses[j + 1])
                                                                               * TheSFH2[i])) / 2.0;
                                    }
                                  else if(j == Mi_lower_SNII && j == Mi_upper_SNII && Mi_lower_actual >= SNII_MIN_MASS) //If mass bin j is BOTH the lowest AND highest mass bin to be integrated over.
                                    {
                                      ...
                                      SNIIRate2[(STEPS * snap) + step][Zi] +=
                                        (1.0 - A_FACTOR) * (Mi_upper_actual -
                                                            Mi_lower_actual) *
                                        ((Chabrier_IMF(Mi_lower_actual) * TheSFH2[i]) +
                                         (Chabrier_IMF(Mi_upper_actual) * TheSFH2[i])) / 2.0;
                                    }
                                  else if(j == Mi_lower_SNII && j == Mi_upper_SNII && Mi_lower_actual < SNII_MIN_MASS)  //If mass bin j is BOTH the lowest AND highest mass bin to be integrated over, AND 'Mi_lower_actual' is below min. mass for SNe-II. (Still only counts stars from SNII_MIN_MASS to Mi_upper_actual).
                                    {
                                      ...
                                      SNIIRate2[(STEPS * snap) + step][Zi] +=
                                        (1.0 - A_FACTOR) * (Mi_upper_actual -
                                                            SNII_MIN_MASS) * ((Chabrier_IMF(SNII_MIN_MASS) *
                                                                               TheSFH2[i]) +
                                                                              (Chabrier_IMF(Mi_upper_actual) *
                                                                               TheSFH2[i])) / 2.0;
                                    }
                                  else if(j == Mi_lower_SNII && j != Mi_upper_SNII)     //If mass bin j IS the lowest but IS NOT the highest mass bin to be integrated over.
                                    {
                                      ...
                                      SNIIRate2[(STEPS * snap) + step][Zi] +=
                                        (1.0 - A_FACTOR) * (SNIIMasses[j + 1] -
                                                            Mi_lower_actual) *
                                        ((Chabrier_IMF(Mi_lower_actual) * TheSFH2[i]) +
                                         (Chabrier_IMF(SNIIMasses[j + 1]) * TheSFH2[i])) / 2.0;
                                    }
                                  ...
                                  if(j != Mi_lower_SNII && j != Mi_upper_SNII)
                                    {
                                      ...
                                      SNIIRate2[(STEPS * snap) + step][Zi] +=
                                        (SNIIMasses[j + 1] -
                                         SNIIMasses[j]) * ((Chabrier_IMF(SNIIMasses[j]) * TheSFH2[i]) +
                                                           (Chabrier_IMF(SNIIMasses[j + 1]) * TheSFH2[i])) /
                                        2.0;
                                    }
                                  else if(j == Mi_lower_SNII && j == Mi_upper_SNII)
                                    {
                                      ...
                                      SNIIRate2[(STEPS * snap) + step][Zi] +=
                                        (Mi_upper_actual -
                                         Mi_lower_actual) * ((Chabrier_IMF(Mi_lower_actual) * TheSFH2[i]) +
                                                             (Chabrier_IMF(Mi_upper_actual) * TheSFH2[i])) /
                                        2.0;
                                    }
                                  else if(j == Mi_lower_SNII && j != Mi_upper_SNII)
                                    {
                              ...
                              if(j != t_lower_lifetime && j != t_upper_lifetime)        //If lifetime bin j is NEITHER the lowest NOR the highest bin to be integrated over.
                                {
                                  ...
                                  SNIaRate2[(STEPS * snap) + step][Zi] +=
                                    A_FACTOR * F316 * KALPHA * (lifetimes[Zi][j] -
                                                                lifetimes[Zi][j +
                                                                              1]) * ((DTD_lower *
                                                                                      TheSFH2[i]) +
                                                                                     (DTD_upper *
                              ...
                              else if(j == t_lower_lifetime && j == t_upper_lifetime)   //If lifetime bin j is BOTH the lowest AND the highest bin to be integrated over.
                                {
                                  ...
                                  SNIaRate2[(STEPS * snap) + step][Zi] +=
                                    A_FACTOR * F316 * KALPHA * (t_upper -
                                                                t_lower) * ((DTD_lower * TheSFH2[i]) +
                                                                            (DTD_upper * TheSFH2[i])) / 2.0;
                                }
                          ...
                          for(j = Mi_lower_AGB; j <= Mi_upper_AGB; j++)
                            {
                              if(j != Mi_lower_AGB && j != Mi_upper_AGB)
                                {
                                  AGBRate2[(STEPS * snap) + step][Zi] +=
                                    (AGBMasses[j + 1] -
                                     AGBMasses[j]) * ((Chabrier_IMF(AGBMasses[j]) * TheSFH2[i]) +
                                                      (Chabrier_IMF(AGBMasses[j + 1]) * TheSFH2[i])) / 2.0;
                                }
